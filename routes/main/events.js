...
module.exports = (router, dbUtils) => {
	...
	//хард роут для мп
	router.get('/event/Astana-Irtysh-10112019', function(req, res, next){
	...
	router.get('/event/partner/:Partner/Astana-Irtysh-10112019', function(req, res, next){
		console.log("get: /event/id");
		var sLogin = "";
		var events = {};
		var sessData = req.session;
	...
	router.get('/event/:id', function(req, res, next){
		...
		if ( eventID == 'Astana-Kaysar-29092019' || eventID == 'astana-kaysar-29092019' || eventID == 'Astana-Kairat-20102019' || eventID == 'astana-kairat-20102019' || eventID == 'Astana-Aktobe-27102019' || eventID == 'astana-aktobe-27102019'){
